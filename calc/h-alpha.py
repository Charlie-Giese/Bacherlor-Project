...
ax2.plot(xr1, np.log(radio_em_vals_1+0.000000001)))
ax2.plot(xr2, np.log(radio_em_vals_2+0.000000001))
ax2.plot(xr3, np.log(radio_em_vals_3+0.000000001))
ax2.plot(xh1, np.log(h_alpha_em_vals_1+0.000000001))
ax2.plot(xh2, np.log(h_alpha_em_vals_2+0.000000001))
ax2.plot(xh3, np.log(h_alpha_em_vals_3+0.000000001))
